    ...
    public function store(Request $request)
    {
        ...
        //traer todas las tareas de un tipo de proyecto
            ...
            if(isset($insercion)){
                ...
                return redirect('/proyectos')->with('success', 'Se ha abierto un nuevo proyecto');
            }else{
                return redirect('/proyectos')->with('danger', 'ocurrió un error al abrir un nuevo proyecto');
            }
        }else{
        ...
        if(isset($resultado)){
            ...
            $predio,$municipio,$num));
             ...
             if(isset($insercion)){
                 ...
                 return redirect('/proyectos')->with('danger', 'Error al actualizar un proyecto');
             }
        }
